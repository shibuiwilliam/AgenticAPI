...
from agenticapi.ext.claude_agent_sdk import _imports as _ext_imports  # noqa: E402
...
def _reset_stub_state() -> None:
    _state.reset()
    # Re-install the stub module to handle the case where earlier tests
    # (e.g. e2e tests for example 13) installed a different stub.
    _install_stub_module()
    _ext_imports._reset_cache_for_tests()
