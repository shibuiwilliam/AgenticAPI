"""Integration tests for OpenAIBackend with a real API key.

Skipped automatically when ``OPENAI_API_KEY`` is not set.
Run manually with::

    OPENAI_API_KEY=sk-... uv run pytest tests/integration/llm/test_real_openai.py -v --timeout=60
"""
...
class TestOpenAIRealToolCalls:
    """Verify tool calling works end-to-end with the real OpenAI API."""
